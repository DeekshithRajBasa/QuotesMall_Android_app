...
public class love extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //firebase database
        myref = FirebaseDatabase.getInstance().getReference().child("/love");
        FirebaseRecyclerAdapter<facebookAdapter, love.BlogViewHolder> recyclerAdapter = new FirebaseRecyclerAdapter<facebookAdapter, love.BlogViewHolder>(
                facebookAdapter.class,
                R.layout.individual_rowfb,
                love.BlogViewHolder.class,
                myref
        ) {

            @Override
            protected void populateViewHolder(love.BlogViewHolder viewHolder, facebookAdapter model, int position) {
