...
public class notification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //firebase database
        myref = FirebaseDatabase.getInstance().getReference().child("/notification");
        FirebaseRecyclerAdapter<facebookAdapter, notification.BlogViewHolder> recyclerAdapter = new FirebaseRecyclerAdapter<facebookAdapter, notification.BlogViewHolder>(
                facebookAdapter.class,
                R.layout.individual_rowfb,
                notification.BlogViewHolder.class,
                myref
        ) {

            @Override
            protected void populateViewHolder(notification.BlogViewHolder viewHolder, facebookAdapter model, int position) {
